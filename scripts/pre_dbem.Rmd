...
file_path <- list.files("~/Library/CloudStorage/OneDrive-UBC/Data/Climate/cimip6/COBALT2/ctrlclim",pattern = "uo",full.names = T)
...
mclapply(seq(1961,2010,1), to_dbem, data = ou_data, var = "AdvectionU_", forcing = "ctrlclim")
